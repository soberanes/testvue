<template>
    <div class="container content">
        ...
        <p>Your order for Sticks will be shipped out within 1-2 business days.
        <br>We sent you a confirmation email for your records. Thanks so much!</p>
        ...
        <div v-if="orderDetails">
            <dl>
                ...
                <dd>{{ orderDetails.shipping.address.line1 }}, 
